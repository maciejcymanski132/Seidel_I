...
class Seidel:
    ...
    def seidel(self,vector_a,vector_b,vector_c):
        ...
        completelyRandomInteger = rnd.randint(0,constr)
        ...
        erasedRow[2] = vector_b[completelyRandomInteger]
        vector_a.pop(completelyRandomInteger)
        vector_b.pop(completelyRandomInteger)
        ...
        if (erasedRow[0] * Xi[0] + (erasedRow[1] * Xi[1])) <= erasedRow[2]:
            ...
            for i in range(0,constr_after_deletion):
                ...
                vector_b[i] += -1.0*change[1] * vector_a[i][0]
                vector_a[i][0] = 0
